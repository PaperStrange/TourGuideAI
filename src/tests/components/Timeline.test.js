...
describe('Timeline Component', () => {
  ...
  test('should render timeline with correct days', () => {
    render(<TimelineComponent timelineData={mockTimelineData} />);
  ...
  test('should display appropriate error message when no timeline data is provided', () => {
    render(<TimelineComponent timelineData={null} />);
  ...
  test('should display appropriate error message when empty timeline data is provided', () => {
    render(<TimelineComponent timelineData={{ travel_split_by_day: [] }} />);
    expect(screen.getByText('No timeline data available')).toBeInTheDocument();
  });
}); 